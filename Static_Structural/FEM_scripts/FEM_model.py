...
from FEM_scripts.Nodes import Nodes
#from FEM_scripts.Spring3D import Spring3D
from FEM_scripts.Member3D import Member3D
from FEM_scripts.Quad3D import Quad3D
from FEM_scripts.Plate3D import Plate3D
from FEM_scripts.LoadCombo import LoadCombo
...
class FEModel3D():
    ...
    def AddPlate(self, Name, iNode, jNode, mNode, nNode, t, E, nu):
        ...
        # Create a new member
        newPlate = Plate3D(Name, self.GetNode(iNode), self.GetNode(jNode), self.GetNode(mNode), self.GetNode(nNode), t,
                           E, nu)
    ...
    def AddQuad(self, Name, iNode, jNode, mNode, nNode, t, E, nu):
        ...
        # Create a new member
        newQuad = Quad3D(Name, self.GetNode(iNode), self.GetNode(jNode), self.GetNode(mNode), self.GetNode(nNode), t, E,
                         nu)
    ...
    # %%
    def DefineSupport(self, Node, SupportDX=False, SupportDY=False, SupportDZ=False, SupportRX=False, SupportRY=False,
                      SupportRZ=False):
        '''
    ...
    # %%
    def DefineReleases(self, Member, Dxi=False, Dyi=False, Dzi=False, Rxi=False, Ryi=False, Rzi=False, Dxj=False,
        ...
        for combo in self.LoadCombos.values():
            ...
            while ((convergence_TC == False or convergence_PD == False)
                ...
                if iter_count_PD == 1:
                    ...
                    K11, K12, K21, K22 = self.__Partition(self.K(combo.name), D1_indices,
                    ...
                    K11, K12, K21, K22 = self.__Partition(self.K(combo.name), D1_indices,
                                                          D2_indices)  # Initial stiffness matrix
                    Kg11, Kg12, Kg21, Kg22 = self.__Partition(self.Kg(combo.name), D1_indices,
